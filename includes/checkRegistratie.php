    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if ($rowCount == 0) {
            ...
            if ($pwd === $pwdRepeat) {
                ...
                $timestamp = 0;
                mysqli_query($conn, "INSERT INTO `users` (`Emailadres`, `Voornaam`, `Achternaam`, `Role`, `Wachtwoord`, `Telnummer`, `LastLoggedin`) VALUES ('$emailadres', '$voornaam', '$achternaam', 'USER', '$hasedWW', '$telnummer', '$timestamp') ");
